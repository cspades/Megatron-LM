...
# export CUDA_DEVICE_MAX_CONNECTIONS=${CUDA_DEVICE_MAX_CONNECTIONS:-128}
...
GPUS_PER_NODE=8
NUM_NODES=$SLURM_NNODES  # 1 or $SLURM_NNODES
MASTER_ADDR=${MASTER_ADDR:-localhost}
MASTER_PORT=${MASTER_PORT:-6000}
NODE_RANK=${NODE_RANK:-$SLURM_NODEID}   # 0 or $SLURM_NODEID
WORLD_SIZE=$(($GPUS_PER_NODE*$NUM_NODES))

echo "WORLD_SIZE=$WORLD_SIZE NODEID=$NODE_RANK MASTER_ADDR=$MASTER_ADDR MASTER_PORT=$MASTER_PORT NUM_NODES=$NUM_NODES GPUS_PER_NODE=$GPUS_PER_NODE"
